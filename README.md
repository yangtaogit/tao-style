...
- 默认偏好冷色调、暗蓝、黑色和灰色。
- 核心颜色锚点为 deep blue `#2A2F80`、black `#000000`、gray `#808080`。muted red `#B04A4A` 仅在需要明确强调时使用，不进入普通序列。
...
- The core color anchors are deep blue `#2A2F80`, black `#000000`, and gray `#808080`. Muted red `#B04A4A` is used only for explicit emphasis and never enters the ordinary sequence.
