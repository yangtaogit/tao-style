...
- Series colors are looked up by count; the set and the order both depend on the number of ordinary series. Deep blue `#2A2F80` and black `#000000` are never adjacent; black enters from three series onward. 1: `#2A2F80`; 2: `#2A2F80`, `#808080`; 3: `#2A2F80`, `#808080`, `#000000`; 4: `#2A2F80`, `#808080`, `#000000`, `#BDBDBD`; 5: `#2A2F80`, `#BDBDBD`, `#4378BC`, `#000000`, `#808080`. Use `series_colors(n)` from the helper script for five series; with more than five ordinary series, switch to a tao blue or tao gray gradient instead of extending the categorical sequence. Muted red `#B04A4A` is only for explicit emphasis. `#6FCCDE` stays only in the tao palette/gradient; the standalone light blue is `#8799CF`.
