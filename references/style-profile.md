...
- Optional τ palette: `#2A2F80`, `#3953A5`, `#4378BC`, `#6FCCDE`, `#99CB6F`, `#F6EB14`, `#F67F21`, `#EE2024`, `#7D1415`. Use it only when a stronger τ color alternative is desired. `#6FCCDE` stays in the τ palette and τ gradient but is not used as a standalone categorical color; the standalone light blue is `#8799CF` from the ? blue gradient.- Sequential colormap: prefer ? gradients and ? gray gradients for many curves or ordered series; use the τ gradient as an optional alternative for dedicated colorbars or heatmaps.
- Preferred ? blue gradient, based on deep blue `#2A2F80`: `#EEF1F8`, `#C8D2EA`, `#8799CF`, `#4E5CA4`, `#2A2F80`.
- Preferred ? gray gradient: white to black.
