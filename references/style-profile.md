...
- Optional rainbow-muted palette for exactly five ordered series where the rainbow order itself carries meaning: `#2A2F80`, `#3596B5`, `#5FA04A`, `#C98526`, `#B04A4A`. It is muted to the Tao Style saturation level and keeps the deep-blue and muted-red anchors. Its luminance is not monotonic in grayscale and green/amber/red can blur under red-green color-vision deficiency, so always pair it with distinct line styles. It does not replace the default per-count sequences.
